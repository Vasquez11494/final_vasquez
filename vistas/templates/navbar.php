<nav class="navbar navbar-expand-lg navbar-dark bg-dark shadow" id="nav_top">
    <div class="container-fluid">
            ...
            <ul class="navbar-nav justify-content-center text-center mx-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="productosDropdown">
                        <li><a class="dropdown-item" href="#"><i class="bi bi-plus-circle-fill me-2"></i>Crear Materias</a></li>
                        <li><a class="dropdown-item" href="#"><i class="bi bi-eye-fill me-2"></i>Ver Materias</a></li>
                    </ul>
                </li>
                <li class="nav-item dropdown">
        ...
        <div class="navbar-text">
            <b>Esc. Informatica y Tecnologia</b>
        </div>
    </div>
</nav>
